		...
		if(isset($login_error)){
			switch($login_error){
				case -1:
					...
					break;
				case -2:
					echo '<p class="error_msg">Es ist kein Benutzer mit dieser E-Mail-Adresse als Organisator registriert.</p>';
					break;
				case -3:
			...
			echo '<p>Hier können Sie sich als Organisator anmelden.</p>';
		}
	?>
	<form action="<?=site('organizer_login')?>" method="post">
