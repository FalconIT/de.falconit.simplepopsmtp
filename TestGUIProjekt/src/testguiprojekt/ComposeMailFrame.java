...
public class ComposeMailFrame extends javax.swing.JFrame {
    ...
    public ComposeMailFrame(String receiver, String mBody) {
        initComponents();
        receiverField.setText(receiver);
        messageBody.setText(mBody);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ComposeMailFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ComposeMailFrame().setVisible(true);
            }
        });
    }
